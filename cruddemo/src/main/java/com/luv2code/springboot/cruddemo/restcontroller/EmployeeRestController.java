...
public class EmployeeRestController {
    ...
    public Employee getEmployeeById(@PathVariable int employeeId){
        Employee theEmployee = employeeServiceInterface.getEmployeeById(employeeId);
        if(theEmployee == null)
            throw new CustomException("404","NOT FOUND","Employee with id " + employeeId + " not found", HttpStatus.NOT_FOUND);
        return theEmployee;
    }
